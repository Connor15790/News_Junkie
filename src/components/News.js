...
const News = (props)=> {
    ...
    const updateNews = async ()=> {
        let url = `https://newsapi.org/v2/top-headlines?&category=${props.category}&country=${props.country}&apiKey=7f268d3830c745d79f5a07d40c1e018f&page=${page}&pageSize=${props.pageSize}`;
        setLoading(true)
